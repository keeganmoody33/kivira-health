...
## 1. Yarly Fassih-Nia — WellMed Medical Management (Tier 1C, H)
...
## 2. Robert Lystrup, MD — Arizona Community Physicians (Tier 1A, H)

**Role:** Medical Director
**Day-to-day:** Clinical operations across a large multi-site primary-care group; physician quality; the standing BH backlog every PCP deals with
**Why he matters:** Classic Clinical Champion at a wedge-fit 1A group. PCPs being "the front line of mental health" is the literal Kivira tagline — that's his world.
...
## 3. Chris Oltmans — NxtCare (Tier 2C, H)

**Role:** Chief Population Health Officer
**Day-to-day:** Population-health program design, care coordination, post-discharge follow-up, risk stratification
**Why he matters:** CPHO is the operator + clinical hybrid we want for 2C care management orgs. BH triage that fits inside an existing care-coordination workflow is a direct overlay on what NxtCare's care teams already do.
...
## 4. Jeremy Wigginton, MD/MBA/FAAFP — Capital Blue Cross (Tier 3C, H)

**Role:** Chief Medical Officer
**Day-to-day:** Clinical strategy across a regional payer's medical management, Stars/HEDIS performance, network quality programs, behavioral-health carve-in/-out decisions
**Why he matters:** Payer-side CMO is the Clinical Champion for 3C. His incentives are BH quality (Stars/HEDIS) and risk-adjustment accuracy on the MA book — both of which our diagnostic-accuracy story lines up with directly.
...
## 5. Christa Thomas, BSN/PA/RN/CCM/CPHQ — Optum (Tier 3C primary / 3A secondary, H)

**Role:** VP Clinical Compliance Operations
**Day-to-day:** Clinical compliance across Optum's enormous footprint — payer side, Optum Care provider arm, quality / regulatory posture across multiple lines of business
**Why she matters:** VP-level operator at the biggest player on the list. Compliance + clinical-grade BH workflow are not natural fits in most BH tools; that's an angle.
...
## 6. Jason Johnson, PMP — Privia Health (Tier 1C, M)

**Role:** Director, Growth
**Day-to-day:** Channel partnerships, network expansion, embedded-platform conversations across Privia's multi-state VBC PCP network
**Why he matters:** Privia's growth side is partnership-shaped. Less buyer than channel — but Privia is a 1C-archetype org, so a channel relationship has compounding upside if it lands.
...
## 7. Lynn LeCluyse — Privia Health (Tier 1C, M)

**Role:** Patient Marketing
**Day-to-day:** Patient-engagement programs, member-marketing campaigns, patient-experience messaging across Privia's network
**Why she matters (lower priority):** Lower seniority and less direct fit than Jason — but Kivira's patient app is free + part of the patient-side experience, so the conversation is real for her. Don't send if you're rationing time; send if you're already messaging Privia and want a second touch in the org.
...
## 8. Chris MacInnis — Old Mission Wound Care (Tier 2C, L)

**Role:** Chief VBC Strategy & Growth Officer
**Day-to-day:** VBC strategy, growth, network development (his headline emphasizes "Acute/Post-Acute & Remote Care Management" — broader than the wound-care org name suggests)
**Why he's borderline:** Wound care isn't our wedge, but his role is squarely on the VBC + care-management spine. Curious-mind touch — verify whether he's buyer-side or vendor-side before committing meeting time.
...
## 9. Kumar Murukurthy, MD — Optimum Healthcare IT (Tier 2B, L)

**Role:** Chief Clinical Officer
**Day-to-day:** Clinical advisory to provider clients of a healthcare-IT consultancy; clinical-workflow guidance across the EHR / interoperability work the firm sells
**Why he's borderline:** Optimum HC IT is a services consultancy, not a platform — could be a channel partner that places Kivira inside provider engagements they're already running, or could be unrelated. CCO + MD makes one curious touch worth it.
...
## 10. Scott Quinn — EVOS Health (Tier 2B, L)

**Role:** Founder
**Day-to-day:** Founder responsibilities at a small healthcare-adjacent startup (verify the company's actual surface on their site before sending — could be partner, could be competitor)
**Why he's borderline:** Need a 30-second site check first. If EVOS is in an adjacent BH or PCP-tooling space, this is a partner / founder conversation. If competitive, skip and mark in the list.
...
## Suggested send order (priority by tier proximity to wedge + confidence)

1. **Yarly Fassih-Nia** (WellMed) — closest to actual buyer persona
2. **Robert Lystrup, MD** (Arizona Community Physicians) — clinical champion, immediate wedge fit
3. **Chris Oltmans** (NxtCare) — strong CPHO operator
