Title: Privacy Policy - Kivira | Solving mental health in primary care

URL Source: https://www.kivira.health/legal/privacy-policy
...
*   **Account and contact information:**name, email address, phone number (if provided), organization or clinic affiliation, role (patient, clinician, admin), and communication preferences/consents related to service and safety communications
...
*   **Offline use:** You can complete assessments without internet connection. When you're offline, your data is encrypted and stored securely on your device. It automatically uploads to our secure servers when you reconnect.
...
When Kivira integrates with EHR systems, we act as a HIPAA Business Associate under Business Associate Agreements with healthcare providers. Your information is Protected Health Information subject to HIPAA protections.
...
If your assessment responses indicate elevated risk of self-harm, we may send a safety outreach email to the address associated with your account that includes crisis hotline numbers and related support resources. We use this information to provide safety-related support communications and to help connect users to appropriate crisis resources. These emails are not emergency response services and do not mean Kivira is monitoring you in real time.

### Safety alerts

If your responses indicate risk of self-harm, we automatically notify your healthcare provider.
...
Kivira uses software algorithms to analyze your assessment responses and generate recommendations for your healthcare provider. These recommendations are reviewed by your provider before any decisions are made.
...
To submit a request, contact us at: [**hello@kivira.health**](mailto:hello@kivira.health).

You may opt out of certain non-essential communications. However, we may continue to send communications that are necessary for safety, security, legal compliance, or core service-related purposes, as permitted by law.
...
**Email:**[hello@kivira.health](mailto:hello@kivira.health)

**Address:** 33 W 17th St
