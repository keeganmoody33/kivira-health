Title: Patient App Terms and Conditions - Kivira | Solving mental health in primary care

URL Source: https://www.kivira.health/legal/patient-app-terms-and-conditions
...
*   Complete intake, screening, assessments, and questionnaires

*   Share your assessment results with authorized clinicians as part of clinical workflow support

*   Access certain EHR data through authorized integrations (for example, Epic via SMART on FHIR)

*   Receive clinician reviewed outputs such as summaries or workflow artifacts

Features vary by Clinic and may change over time.

## 5. Clinical Decision Support Only

The App may use software algorithms, including AI-assisted methods, to analyze assessment responses and generate outputs such as summaries, insights, or recommendations for your healthcare provider. These outputs are designed to support human decision-making and **do not replace clinical judgment**.

Your clinician remains responsible for all clinical decisions, including diagnosis and treatment. Your Clinic may configure the App so that certain outputs are reviewed by a clinician before they are shared with you.
...
If your responses indicate risk of self-harm, Kivira automatically notifies your healthcare provider according to your Clinic’s configuration and workflow. In addition, where enabled by your Clinic or Kivira workflow, we may send an email to the address associated with your account containing crisis hotline numbers and other support resources.

These notifications and emails are informational safety support only. They are **not emergency care**, are **not continuously monitored**, and are **not guaranteed to be immediate**. If you are in immediate danger, call 911 (or your local emergency number) or go to the nearest emergency department.

1.   ## Consent to Electronic Communications

By providing or confirming your email address and using the App, you consent to receive electronic communications from Kivira related to your use of the Services, including account and security messages, service notices, and safety-related messages (such as crisis resource emails when risk indicators are present). You are responsible for providing an accurate email address and updating it if it changes. Message frequency may vary based on your use of the App, your Clinic’s configuration, and safety-related events. You may be able to opt out of certain non-essential communications, but we may still send communications that are necessary for safety, security, legal compliance, or core service operation as permitted by law.

## 9. Invitations, Accounts, and Authentication

You may access the App through one of the following routes:

*   **Epic MyChart invitation route:** Your clinician may send an invitation link to your MyChart. You may be directed to download the App from the Apple App Store. You authenticate via MyChart using Epic SMART on FHIR OAuth 2.0 authorization code flow with PKCE. Kivira does not receive your MyChart password.

*   **Non-Epic email invitation route:** A clinician may send an invitation link by email. You may complete sign-up using Kivira’s authentication flow, including an activation token sent in the invitation email.
...
*   Secure your device (for example, passcode, biometrics where available)
...
*   Disrupt or interfere with the App, including introducing malware

*   Reverse engineer the App except where prohibited by law

## 12. Privacy, HIPAA, and Data Use

Your use of the App is also governed by Kivira’s Privacy Policy: https://www.kivira.health/legal/privacy-policy.

The Services may process information that can be considered health information or sensitive information, such as mental health assessment responses. Where Kivira integrates with EHR systems, Kivira acts as a HIPAA Business Associate under business associate agreements with healthcare providers, and information may be protected health information under HIPAA.
...
Kivira may also use de-identified and aggregated data to refine and evaluate its algorithms and for research projects and cohort analyses with partners, where permitted by law and by Clinic arrangements. De-identified data is intended not to identify you.
...
This page is provided for informational purposes and should be reviewed by your legal counsel to ensure it fits your specific deployment, Customer contracts, and regulatory posture.
